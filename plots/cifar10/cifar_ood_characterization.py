...
file_path = '../../results/cifar10/cifar10_c_divergences.csv'  # Replace with your actual file path
...
plt.text(0, -0.15, 'CIFAR-10', ha='center', color='blue', fontsize=22, fontweight='bold')  # Increase text size
...
text_y_position = grouped_data['upper'].max() - 0.05
...
for category, pos in zip(['Lowest', 'Mid-Range', 'Highest'], [12.5, 50, 87.5]):
    ...
    plt.text(pos, text_y_position - 0.18,  # Adjust position slightly below
