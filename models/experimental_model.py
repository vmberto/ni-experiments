...
class ExperimentalModel:
    ...
    def fit(self, train_dataset, val_dataset=None, callbacks=None, batch_size=32, epochs=10, fold_number=0):
    ...
    def evaluate(self, eval_ds, corruption_type, aug_layers, execution_name):
        loss, acc = self.model.evaluate(eval_ds)

        write_evaluation_result(corruption_type, aug_layers, execution_name, loss, acc)
