...
WeakRandAugment = get_text_randaugment_layers(swap_max=.1, sub_max=.1, char_max=.1)
...
CONFIGS = [
    ...
    },
    {
        ...
        "data_augmentation_layers": [RandAugment, RandomSaltAndPepper(max_factor=SALT_PEPPER_FACTOR)],
        "curriculum_learning": False,
        "active": False,
    },
    {
    ...
    },
    {
        ...
        "data_augmentation_layers": [
            [],
            [RandomSaltAndPepper(max_factor=.1)],
            [RandAugment, RandomSaltAndPepper(max_factor=SALT_PEPPER_FACTOR)],
        ],
        "es_patience_stages": [8, 8, 10],
